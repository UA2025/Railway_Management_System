 ...
 * @author hp
 */
public class MaintenanceGUI1 extends javax.swing.JFrame {
public int adid;
    /**
     * Creates new form MaintenanceGUI
     */
    public MaintenanceGUI1() {
        initComponents();
        addActionListeners();
        addActionListeners6();
       addActionListeners2();
    ...
    private void showdata()
    {
        ...
        Maintenance Main5=new Maintenance(5);
        Maintenance Main2=new Maintenance(2);
        Maintenance Main3=new Maintenance(3);
        Maintenance Main4=new Maintenance(4);
        //Main1
        jLabel30.setText(Main5.getAdminName());
        jLabel21.setText(Main5.getDate());
        jLabel15.setText(Main5.getReason());
        jLabel11.setText(Main5.getTrainName());
        //Main2
